...
from srf.config import TestOptions
from srf.model import build_model
from srf.span_utils import span_cxw_to_xx
from srf.start_end_dataset import StartEndDataset, start_end_collate, prepare_batch_inputs
from srf.start_end_dataset_audio import \
    StartEndDataset_audio, start_end_collate_audio, prepare_batch_inputs_audio
from srf.postprocessing_srf import PostProcessorDETR
...
if __name__ == '__main__':
    # print(len(argv))  # 실행 시 전달된 인수 개수 확인
    # print(argv)
    _,_,_,_,split,_,splitfile = argv
    # _,_,_,_,split,_,splitfile,_,_,_,_ = argv
