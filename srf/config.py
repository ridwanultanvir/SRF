...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--c_feat_dir", type=str, help="video caption feature dir")
        parser.add_argument("--c_feat_dim", type=int, help="video caption feature dim")
        parser.add_argument("--iter_num", type=int, default=5, help="number of iterations for each video")
        # Model config
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['srf/model.py', 'srf/transformer.py']
